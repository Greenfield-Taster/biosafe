        ...
        <section className="consulting__hero">
          <div className="consulting__hero-content">
            <h1 className="consulting__title">
              Консультації медичних лабораторій
            </h1>
        ...
        <section className="consulting__content">
          ...
          <div className="consulting__text-card consulting__text-card--secondary">
            ...
            <div className="consulting__text-content">
              ...
              <p>
                Ми супроводжуємо лабораторії на всіх етапах - від проєктування
                та запуску до успішного проходження акредитації. Підтримка у
          ...
          <div className="consulting__text-card consulting__text-card--tertiary">
            ...
            <div className="consulting__text-content">
              ...
              <p>
                Окрім підготовки до акредитації, ми пропонуємо постійну
                підтримку та супровід функціонування системи якості, допомагаючи
                лабораторіям залишатися відповідними стандартам у щоденній
                роботі.
              </p>
            </div>
